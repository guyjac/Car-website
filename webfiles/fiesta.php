  ...
  <body>
	  <div id="navBar">
		...
		<h1 class="dep">MODELS</h1>
			<ul class="sidebar">
			  <li class="curSide"><a class="side" href="fiesta.php">Fiesta</a></li>
			  <li class="sidebar"><a class="side" href="mondeo.php">Mondeo</a></li>
			  <li class="sidebar"><a class="side" href="focus.php">Focus</a></li>
			</ul>
		</div>
				<?php
					//Creates the webpage. uses the word fiesta to fetch db items
					$page_id ="Fiesta";
